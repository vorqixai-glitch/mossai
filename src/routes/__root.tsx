...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Emergent is a fast, focused AI workspace. Multi-model chat, projects, artifacts and prompt libraries — designed for people who ship." },
      { property: "og:title", content: "Emergent — AI chat workspace" },
      { property: "og:description", content: "Fast, focused AI chat with multi-model routing, projects and artifacts." },
